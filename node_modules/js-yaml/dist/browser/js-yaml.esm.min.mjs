...
function r(e, t) {
	...
	return {
		...
		create: t.create,
		addItem: t.addItem,
		identify: (r = t.identify) == null ? null : r,
		represent: (i = t.represent) == null ? ((e) => e) : i,
		representTagName: (a = t.representTagName) == null ? null : a
	};
}
function i(e, t) {
	var n, r, i, a;
...
var ce = n("tag:yaml.org,2002:int", {
	...
	resolve: se,
	identify: (e) => Object.prototype.toString.call(e) === "[object Number]" && e % 1 == 0 && !Object.is(e, -0),
...
function Qt(t, n) {
	...
	if (i !== "") {
		...
		let n = Kt(i, t.tagHandlers), s = Xt(t.schema.exact.scalar, t.schema.prefix.scalar, n);
		if (s) {
		...
		let c = (o = Xt(t.schema.exact.mapping, t.schema.prefix.mapping, n)) == null ? Xt(t.schema.exact.sequence, t.schema.prefix.sequence, n) : o;
		if (c) return r !== "" && S(t, `cannot resolve a node with !<${n}> explicit tag`), {
			value: c.create(n),
			tag: c
		};
...
function an(e, t, n) {
	...
	if (r.kind === "document") r.value = t, r.hasValue = !0;
		...
		r.merge && (en(n) || S(e, "cannot merge mappings; the provided source object is unacceptable"), r.index >= e.maxMergeSeqLength && S(e, `merge sequence length exceeded maxMergeSeqLength (${e.maxMergeSeqLength})`));
		let i = r.tag.addItem(r.value, t, r.index++);
		i && S(e, i);
	} else if (r.hasKey) {
		let i = r.key;
		r.key = void 0, r.hasKey = !1, rn(e, r, i, t, n);
	} else r.key = t, r.keyPosition = e.position, r.hasKey = !0;
}
function on(e, t, n, r) {
	t.anchorStart !== x && e.anchors.set(e.source.slice(t.anchorStart, t.anchorEnd), {
		value: n,
		tag: r
	});
}
function sn(e, n) {
	...
	for (; r.eventIndex < r.events.length;) {
		...
		switch (r.position = Yt(e), e.type) {
			case 1:
				r.anchors = /* @__PURE__ */ new Map(), r.tagHandlers = Object.create(null);
				...
				break;
			case 4: {
				let { value: t, tag: n } = Qt(r, e);
				on(r, e, t, n), an(r, t, n);
				break;
			}
			case 2: {
				let n = $t(r, e, r.schema.exact.sequence, r.schema.prefix.sequence, "tag:yaml.org,2002:seq", "sequence"), i = n.tag.create(n.tagName);
				on(r, e, i, n.tag);
				let a = r.frames[r.frames.length - 1], o = a !== void 0 && a.kind === "mapping" && a.hasKey && a.key === t;
				r.frames.push({
					kind: "sequence",
					position: r.position,
					value: i,
			...
			case 3: {
				let t = $t(r, e, r.schema.exact.mapping, r.schema.prefix.mapping, "tag:yaml.org,2002:map", "mapping"), n = t.tag.create(t.tagName);
				on(r, e, n, t.tag), r.frames.push({
					kind: "mapping",
					position: r.position,
					value: n,
					tag: t.tag,
			...
			case 5: {
				...
				n || S(r, `unidentified alias "${t}"`), an(r, n.value, n.tag);
				break;
			}
			case 6: {
				let e = r.frames.pop();
				e.kind === "document" ? r.documents.push(e.value) : an(r, e.value, e.tag);
				break;
			}
		}
	}
...
var C = -1, cn = Object.prototype.hasOwnProperty, w = 1, ln = 2, un = 3, dn = 4, fn = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, pn = /[,\[\]{}]/, mn = /^(?:!|!!|![0-9A-Za-z-]+!)$/, hn = String.raw`(?:%[0-9A-Fa-f]{2}|[0-9A-Za-z\-#;/?:@&=+$,_.!~*'()\[\]])`, gn = String.raw`(?:%[0-9A-Fa-f]{2}|[0-9A-Za-z\-#;/?:@&=+$.~*'()_])`, _n = RegExp(`^(?:${hn})*$`), vn = RegExp(`^(?:${gn})+$`), yn = RegExp(`^(?:!(?:${hn})*|${gn}(?:${hn})*)$`), bn = {
	filename: "",
	maxDepth: 100
};
function xn(e, t, n) {
...
function L(e, t) {
	...
	for (; r !== 0;) {
		...
		while (!M(r) && r !== 0);
		if (!M(r)) break;
		for (kn(e), n++, i = !0, r = e.input.charCodeAt(e.position); r === 32;) e.lineIndent++, r = e.input.charCodeAt(++e.position);
	}
	return n;
}
...
function jn(e, t, n) {
	fn.test(e.input.slice(t, n)) && j(e, "the stream contains non-printable characters");
}
function Mn(e, t, n) {
	...
	if (i) {
		...
		for (; s !== 0 && !P(s) && !(n && I(s));) s === 33 && (a ? j(e, "tag suffix cannot contain exclamation marks") : (o = e.input.slice(c - 1, e.position + 1), mn.test(o) || j(e, "named tag handle cannot contain such characters"), a = !0, c = e.position + 1)), s = e.input.charCodeAt(++e.position);
		l = e.input.slice(c, e.position), pn.test(l) && j(e, "tag suffix cannot contain flow indicator characters");
	}
	return l && !(i ? _n.test(l) : vn.test(l)) && j(e, `tag name cannot contain such characters: ${l}`), !i && o !== "!" && o !== "!!" && !cn.call(e.tagHandlers, o) && j(e, `undeclared tag handle "${o}"`), t.tagStart = r, t.tagEnd = e.position, !0;
}
function Nn(e, t) {
...
function Pn(e, t) {
	...
	let n = e.position;
	for (; e.input.charCodeAt(e.position) !== 0 && !P(e.input.charCodeAt(e.position)) && !I(e.input.charCodeAt(e.position));) e.position++;
	return e.position === n && j(e, "name of an alias node must contain at least one character"), Cn(e, n, e.position), !0;
}
function Fn(e, t) {
...
function In(e, t, n) {
	...
	for (; e.input.charCodeAt(e.position) !== 0;) {
		...
		M(a) ? (i = !1, Fn(e, t)) : e.position === e.lineStart && R(e) ? j(e, "unexpected end of the document within a single quoted scalar") : a !== 9 && a < 32 ? j(e, "expected valid JSON character") : e.position++;
	}
...
function Ln(e, t, n) {
	...
	for (; e.input.charCodeAt(e.position) !== 0;) {
		...
		if (a === 92) {
			...
			if (M(n)) Fn(e, t);
			else if (On(n)) e.position++;
			else {
				let t = Dn(n);
				for (t === 0 && j(e, "unknown escape sequence"); t-- > 0;) e.position++, En(e.input.charCodeAt(e.position)) < 0 && j(e, "expected hexadecimal character");
				e.position++;
			}
		} else M(a) ? (i = !1, Fn(e, t)) : e.position === e.lineStart && R(e) ? j(e, "unexpected end of the document within a double quoted scalar") : a !== 9 && a < 32 ? j(e, "expected valid JSON character") : e.position++;
	}
...
function Rn(e, t, n) {
	...
	for (e.position++; e.input.charCodeAt(e.position) !== 0;) {
		let n = e.input.charCodeAt(e.position), r = Tn(n);
	...
	c && e.input.charCodeAt(e.position) === 35 && An(e), M(e.input.charCodeAt(e.position)) ? kn(e) : e.input.charCodeAt(e.position) !== 0 && j(e, "a line break is expected");
	...
	for (; e.input.charCodeAt(e.position) !== 0;) {
		...
		An(e), f = e.position, M(e.input.charCodeAt(e.position)) && (kn(e), f = e.position);
	}
	return jn(e, d, f), E(e, d, f, n.anchorStart, n.anchorEnd, n.tagStart, n.tagEnd, s, i, l), !0;
}
function zn(e, t) {
...
function Bn(e, t, n, r) {
	...
	return a === i ? !1 : (jn(e, i, a), E(e, i, a, r.anchorStart, r.anchorEnd, r.tagStart, r.tagEnd, 1, 1, -1, !c), !0);
}
function z(e, t) {
	let n = e.line;
...
function Vn(e, t, n) {
	...
	let s = i ? 125 : 93;
	for (i ? T(e, a, n.anchorStart, n.anchorEnd, n.tagStart, n.tagEnd, 2) : Sn(e, a, n.anchorStart, n.anchorEnd, n.tagStart, n.tagEnd, 2), e.position++; e.input.charCodeAt(e.position) !== 0;) {
		z(e, t);
		let n = e.input.charCodeAt(e.position);
...
function Hn(e, t, n) {
	...
	for (Sn(e, e.position, n.anchorStart, n.anchorEnd, n.tagStart, n.tagEnd, 1); e.input.charCodeAt(e.position) === 45 && F(e.input.charCodeAt(e.position + 1));) {
		e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, j(e, "tab characters must not be used in indentation"));
		let n = e.line;
		e.position++;
		let r = L(e, !0) > 0;
		if (e.firstTabInLine !== -1 && e.input.charCodeAt(e.position) === 45 && F(e.input.charCodeAt(e.position + 1)) && j(e, "bad indentation of a sequence entry"), r && e.lineIndent <= t ? O(e) : B(e, t, un, !1, !0), L(e, !0), e.lineIndent < t || e.position >= e.length) break;
...
function Un(e, t, n, r) {
	...
	for (; c !== 0;) {
			...
			if (e.line === u) {
				...
				if (c === 58) {
					if (c = e.input.charCodeAt(++e.position), F(c) || j(e, "a whitespace character is expected after the key-value separator within a block mapping"), !o) {
						for (A(e, t), T(e, t.position, r.anchorStart, r.anchorEnd, r.tagStart, r.tagEnd, 1), o = !0, B(e, n, ln, !1, !0), c = e.input.charCodeAt(e.position); N(c);) c = e.input.charCodeAt(++e.position);
						e.position++;
					}
					a = !0, i = !1, s = !1;
		...
		if (B(e, t, dn, !0, s) && (s = !1), i || s && (O(e), s = !1), L(e, !0), c = e.input.charCodeAt(e.position), (e.line === u || e.lineIndent > t) && c !== 0) j(e, "bad indentation of a mapping entry");
...
function B(e, t, n, r, i, a = !0) {
	...
	let o = 1, s = !1, c = !1, l = null, u = wn(), d = n === dn || n === un, f = d, p = d;
	...
	if (o === 1) for (;;) {
		...
		if (s && p && (u.tagStart !== C || u.anchorStart !== C) && (r === 33 || r === 38)) {
			var m;
			let n = k(e), r = t + 1;
			if (Un(e, e.position - e.lineStart, r, u) && ((m = e.events[n.eventsLength]) == null ? void 0 : m.type) === 3) return e.depth--, !0;
			A(e, n);
		}
		if (s && (r === 33 && u.tagStart !== C || r === 38 && u.anchorStart !== C) || !Mn(e, u, n === w) && !Nn(e, u)) break;
		l === null && (l = i), L(e, !0) ? (s = !0, f = p, o = e.lineIndent > t ? 1 : e.lineIndent === t ? 0 : -1) : f = !1;
	}
	if (f && (f = s || i), o === 1 || n === dn) {
		let r = n === w || n === ln ? t : t + 1, i = e.position - e.lineStart;
		if (o === 1) if (f && (Hn(e, i, u) || Un(e, i, r, u)) || Vn(e, r, u)) c = !0;
		else {
			let t = e.input.charCodeAt(e.position);
			if (l !== null && a && p && !f && t !== 124 && t !== 62) {
				var h;
				let t = k(e), n = l.position - l.lineStart;
				A(e, l), Un(e, n, r, wn()) && ((h = e.events[t.eventsLength]) == null ? void 0 : h.type) === 3 ? c = !0 : A(e, t);
			}
			!c && (d && Rn(e, r, u) || In(e, r, u) || Ln(e, r, u) || Pn(e, u) || Bn(e, r, n, u)) && (c = !0);
		}
		else o === 0 && (c = f && Hn(e, i, u));
	}
...
function Wn(e) {
	...
	if (M(e.input.charCodeAt(e.position)) && kn(e), n === "YAML") {
		...
		let [t, n] = r;
		mn.test(t) || j(e, "ill-formed tag handle (first argument) of the TAG directive"), cn.call(e.tagHandlers, t) && j(e, `there is a previously declared suffix for "${t}" tag handle`), yn.test(n) || j(e, "ill-formed tag prefix (second argument) of the TAG directive"), e.tagHandlers[t] = n, e.directives.push({
			kind: "tag",
			handle: t,
			prefix: n
		});
...
function Gn(e) {
	...
	if (xn(e, n, !1), B(e, e.lineIndent - 1, dn, !1, i, i) || O(e), L(e, !0), e.position === e.lineStart && R(e) && (r = e.input.charCodeAt(e.position) === 46, r)) {
		let t = e.line;
...
function Kn(e, t) {
	...
	for (i !== -1 && pt(e, i, "null byte is not allowed in input", r.filename), r.input.charCodeAt(r.position) === 65279 && r.position++; r.position < r.length && (L(r, !0), !(r.position >= r.length));) {
		let e = r.position;
		Gn(r), r.position === e && j(r, "can not read a document");
	}
	return r.events;
}
//#endregion
...
var qn = y(y({}, bn), Jt);
function Jn(e, t = {}) {
	let n = y(y({}, qn), t), r = String(e), i = Object.keys(bn), a = Object.keys(Jt);
	return sn(Kn(r, Ke(n, i)), y(y({}, Ke(n, a)), {}, { source: r }));
}
function Yn(e, t, n) {
	let r = null;
...
var er = Symbol("visit:break"), tr = Symbol("visit:skip");
function nr(e, t, n) {
	let r = t(e, n);
	if (r === er) return !0;
	if (r === tr) return !1;
	...
	switch (e.kind) {
		case "sequence":
			for (let n of e.items) if (nr(n, t, {
				depth: i,
				parent: e,
				isKey: !1
			})) return !0;
			break;
		case "mapping":
			for (let { key: n, value: r } of e.items) if (nr(n, t, {
				depth: i,
				parent: e,
				isKey: !0
			}) || nr(r, t, {
...
function rr(e, t) {
	for (let n of e) if (n.contents && nr(n.contents, t, {
		depth: 0,
		parent: null,
		isKey: !1
	})) return;
...
var ir = 65279, ar = 9, W = 10, or = 13, sr = 32, cr = 33, lr = 34, ur = 35, dr = 37, fr = 38, pr = 39, mr = 42, hr = 44, gr = 45, G = 58, _r = 61, vr = 62, yr = 63, br = 64, xr = 91, Sr = 93, Cr = 96, wr = 123, Tr = 124, Er = 125, K = {};
...
function Fr(e) {
	...
	if (t !== gr && t !== 46 || e.charCodeAt(1) !== t || e.charCodeAt(2) !== t) return !1;
	if (e.length === 3) return !0;
	let n = e.charCodeAt(3);
	return q(n) || n === or || n === W;
}
function J(e) {
	return e >= 32 && e <= 126 || e >= 161 && e <= 55295 && e !== 8232 && e !== 8233 || e >= 57344 && e <= 65533 && e !== ir || e >= 65536 && e <= 1114111;
}
function Ir(e) {
	return J(e) && e !== ir && e !== or && e !== W;
}
function Lr(e, t, n) {
	let r = Ir(e), i = r && !q(e);
	return (n ? r : r && e !== hr && e !== xr && e !== Sr && e !== wr && e !== Er) && e !== ur && !(t === G && !i) || Ir(t) && !q(t) && e === ur || t === G && i;
}
function Rr(e) {
	return J(e) && e !== ir && !q(e) && e !== gr && e !== yr && e !== G && e !== hr && e !== xr && e !== Sr && e !== wr && e !== Er && e !== ur && e !== fr && e !== mr && e !== cr && e !== Tr && e !== _r && e !== vr && e !== pr && e !== lr && e !== dr && e !== br && e !== Cr;
}
function zr(e, t) {
	let n = Y(e, 0);
	if (Rr(n)) return !0;
	if (e.length > 1 && (n === gr || n === yr || n === G)) {
		let r = Y(e, 1);
		return !q(r) && Lr(r, n, t);
	}
	return !1;
...
var X = 1, Hr = 2, Ur = 3, Wr = 4, Z = 5;
function Gr(e, t, n, r, i) {
	let { blockIndent: a, lineWidth: o } = n, s = e.quoteStyle !== "auto", c, l = 0, u = -1, d = !1, f = !1, p = o !== -1, m = -1, h = !Fr(t) && zr(t, i) && Br(Y(t, t.length - 1));
	if (r || s) for (c = 0; c < t.length; l >= 65536 ? c += 2 : c++) {
		if (l = Y(t, c), !J(l)) return Z;
		h = h && Lr(l, u, i), u = l;
	}
	else {
		for (c = 0; c < t.length; l >= 65536 ? c += 2 : c++) {
			if (l = Y(t, c), l === W) d = !0, p && (f = f || c - m - 1 > o && t[m + 1] !== " ", m = c);
			else if (!J(l)) return Z;
			h = h && Lr(l, u, i), u = l;
		}
		f = f || p && c - m - 1 > o && t[m + 1] !== " ";
	}
	return !d && !f ? h && !s ? X : e.quoteStyle === "double" ? Z : Hr : a > 9 && Vr(t) ? Z : f ? Wr : Ur;
}
function Kr(e, t, n) {
	let { indent: r, blockIndent: i, lineWidth: a } = n;
	switch (t) {
		case X: return Yr(e, r);
		case Hr: return `'${Yr(e, r).replace(/'/g, "''")}'`;
		case Ur: return "|" + Jr(e, i) + Xr(jr(e, r));
		case Wr: return ">" + Jr(e, i) + Xr(jr(Zr(e, a), r));
		case Z: return `"${$r(e)}"`;
	}
}
function qr(e, t, n, r, i) {
	let a = r || !i;
	if (t.style.singleQuoted) return Hr;
	...
	let o = t.value;
	if (o.length === 0) return e.quoteStyle === "auto" && (t.style.tagged || Pr(e, o) === t.tag) ? X : e.quoteStyle === "double" ? Z : Hr;
	let s = Gr(e, o, n, a, i);
	return s === X && !t.style.tagged && Pr(e, o) !== t.tag ? Hr : s;
}
function Jr(e, t) {
...
function ti(e, t, n, r) {
	...
	for (let a = 0, o = n.items.length; a < o; a += 1) {
		...
		(!r || i !== "") && (i += Mr(e, t)), o === "" || W === o.charCodeAt(0) ? i += "-" : i += "- ", i += o;
	}
	return i;
}
function ni(e, t, n) {
...
function ai(e, t, n, r) {
	...
	for (let n = 0, o = a.length; n < o; n += 1) {
		...
		f && (u && W === u.charCodeAt(0) ? o += "?" : o += "? "), o += u, f && (o += Mr(e, t));
		let p = Q(e, t + 1, c, {
			block: !0,
			compact: f,
			isblockseq: f && !oi(e, c, t + 1)
		}), m = s.kind === "scalar" && s.value === "" && u !== "" && u.charCodeAt(u.length - 1) !== pr && u.charCodeAt(u.length - 1) !== lr, h = !f && (s.kind === "alias" || m) ? " " : "";
...
function pi(e, t = {}) {
	let n = y(y({}, fi), t), r = $n(e, n.schema, {
		noRefs: n.noRefs,
		skipInvalid: n.skipInvalid
	});
	return n.flowLevel >= 0 && rr(r, (e, t) => {
		if (!(t.depth < n.flowLevel)) return e.style.flow = !0, tr;
	}), n.transform(r), ui(r, y(y({}, Ke(n, Object.keys(Dr))), {}, { schema: n.schema }));
}
//#endregion
...
function vi(e, t) {
	let n = Ut(e.source, t), r = hi(e, t), i = new V();
	switch (t.style) {
		case 2:
			i.singleQuoted = !0;
			break;
	...
	let a;
	return r === "" ? a = t.style === 1 ? _i(e, n) : e.schema.defaultScalarTag.tagName : (i.tagged = !0, a = r), {
		kind: "scalar",
		tag: a,
		style: i,
		anchor: gi(e, t),
	...
	for (; n.eventIndex < e.length;) {
		...
		switch (n.position = mi(t), t.type) {
			...
			case 4:
				...
				break;
			case 2: {
				let { tag: e, style: r, anchor: i } = yi(n, t, "tag:yaml.org,2002:seq"), a = {
					kind: "sequence",
					tag: e,
					style: r,
					anchor: i,
			...
			case 3: {
				let { tag: e, style: r, anchor: i } = yi(n, t, "tag:yaml.org,2002:map"), a = {
					kind: "mapping",
					tag: e,
					style: r,
					anchor: i,
...
//#endregion
export { Dt as CHOMPING_CLIP, kt as CHOMPING_KEEP, Ot as CHOMPING_STRIP, Tt as COLLECTION_STYLE_BLOCK, Et as COLLECTION_STYLE_FLOW, nt as CORE_SCHEMA, vt as EVENT_ALIAS, mt as EVENT_DOCUMENT, gt as EVENT_MAPPING, yt as EVENT_POP, _t as EVENT_SCALAR, ht as EVENT_SEQUENCE, et as FAILSAFE_SCHEMA, tt as JSON_SCHEMA, t as MERGE_KEY, e as NOT_RESOLVED, St as SCALAR_STYLE_DOUBLE_QUOTED, wt as SCALAR_STYLE_FOLDED_BLOCK, Ct as SCALAR_STYLE_LITERAL_BLOCK, bt as SCALAR_STYLE_PLAIN, xt as SCALAR_STYLE_SINGLE_QUOTED, v as Schema, V as Style, er as VISIT_BREAK, tr as VISIT_SKIP, rt as YAML11_SCHEMA, b as YAMLException, Le as binaryTag, p as boolCoreTag, ee as boolJsonTag, re as boolYaml11Tag, sn as constructFromEvents, i as defineMappingTag, n as defineScalarTag, r as defineSequenceTag, pi as dump, xi as eventsToAst, Se as floatCoreTag, De as floatJsonTag, Me as floatYaml11Tag, Ut as getScalarValue, ce as intCoreTag, pe as intJsonTag, _e as intYaml11Tag, $n as jsToAst, ot as legacyMapTag, Xn as load, Yn as loadAll, qe as mapTag, Ne as mergeTag, s as nullCoreTag, c as nullJsonTag, u as nullYaml11Tag, Ue as omapTag, We as pairsTag, Kn as parseEvents, ui as present, it as realMapTag, He as seqTag, Je as setTag, a as strTag, Ve as timestampTag, rr as visit };
